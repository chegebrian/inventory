...
const RevealSection = ({ children, style }) => {
  const ref = useReveal();
  return (
    <div ref={ref} className="lp-reveal" style={style}>
      {children}
    </div>
  );
};
  ...
  const features = [
    {
      ...
      desc: "Log received quantities, spoilage, and in-stock levels for every product across all branches — instantly updated.",
    },
    {
      icon: "🏪",
      title: "Multi-Store Management",
      desc: "Run multiple branches from one merchant dashboard. Compare performance and view consolidated reports.",
    },
    {
      icon: "🔐",
      title: "Secure Invite System",
      desc: "Onboard staff via secure email invite tokens with 24-hour expiry. No unauthorized access ever.",
    },
    {
      icon: "🚚",
      title: "Supply Request Workflow",
      desc: "Clerks request supplies in seconds. Admins approve or decline with a note — all tracked in real time.",
    },
    {
      icon: "📊",
      title: "Visual Reports & Charts",
      desc: "Bar and line charts surface stock trends, payment summaries and per-store comparisons at a glance.",
    },
    {
      icon: "💳",
      title: "Payment Status Tracking",
      desc: "Mark inventory entries as paid or unpaid. Track outstanding amounts per store with instant totals.",
    },
  ];
  ...
  const roles = [
    {
      ...
      perks: [
        ...
        "Create and delete stores & products",
      ],
    },
    {
      emoji: "👔",
      ...
      perks: [
        "Manage products per store",
        "Approve or decline supply requests",
        "Update payment status",
        "Invite and manage clerks",
      ],
    },
    {
      emoji: "📝",
      ...
      perks: [
        "Record daily inventory entries",
        "Submit supply requests",
        "View personal entry history",
        "Track stock and spoilage",
      ],
    },
  ];
    ...
    <div className="lp-page">
      ...
      <section className="lp-hero">
        ...
        <p className="lp-hero-sub lp-hero-paragraph">
          StockPilot gives merchants, admins and clerks a unified platform to
          track inventory, manage supply chains and make smarter decisions — in
          real time.
        </p>

        <div className="lp-hero-btns lp-hero-buttons">
          <button
            className="lp-btn-primary hero"
            onClick={() => navigate("/login")}
          >
            Get Started — Sign In
          </button>
            ...
            {roles.map((r, i) => (
              <RevealSection key={i} style={{ transitionDelay: `${i * 0.1}s` }}>
                ...
                >
                  ...
                  <h3 className="lp-role-title" style={{ color: r.color }}>
                    {r.role}
                  </h3>
      ...
      <section id="about" className="lp-section">
        <div className="lp-section-inner narrow">
          <RevealSection>
            ...
            <h2 className="lp-section-title">
              Built for growing retail businesses
            </h2>
            <p className="lp-about-text">
              StockPilot was designed to solve the real operational challenges
              that small and medium retail businesses face when managing
              inventory across multiple store branches. From recording daily
              stock to approving supply requests, every workflow is built to be
              fast, simple and reliable.
            </p>
            <p className="lp-about-text">
              Powered by Flask, React and PostgreSQL — with JWT authentication,
              role-based access control, Cloudinary image uploads and a clean
              dashboard experience for every member of your team.
            </p>
        ...
        <RevealSection>
          <div className="lp-cta-inner">
            ...
            <p className="lp-cta-sub">
              Sign in and start managing your stores in minutes. No setup
              required.
            </p>
        ...
        <div className="lp-footer-inner">
          <div className="lp-logo">
            <div
              ...
              style={{ width: 30, height: 30, fontSize: 15, borderRadius: 8 }}
            >
              📦
            </div>
            <span className="lp-logo-text" style={{ color: "#334155" }}>
              StockPilot
            </span>
          </div>
